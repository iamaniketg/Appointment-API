...
import com.assignment.Appointment.API.model.dto.SignInInput;
import com.assignment.Appointment.API.model.dto.SignUpOutput;
import com.assignment.Appointment.API.repository.IAuthTokenRepo;
import com.assignment.Appointment.API.repository.IDoctorRepo;
import com.assignment.Appointment.API.repository.IPatientRepo;
import com.assignment.Appointment.API.service.emailUtility.EmailHandler;
import com.assignment.Appointment.API.service.hashingUtility.PasswordEncryptor;
...
public class PatientService {
    ...
    public SignUpOutput signUpPatient(Patient patient) {
        ...
        try {
            String encryptedPassword = PasswordEncryptor.encryptPassword(patient.getPatientPassword());
